      ...
      <main className="flex-grow flex flex-col overflow-y-auto pb-24 bg-white">
        {loading ? (
          ...
          orders.map((order) => {
            ...
            const sideColor = isBuy ? 'text-[#129A43]' : 'text-[#d82034]';
            ...
            if (order.status === 'Đã khớp') statusBulletColor = 'bg-[#129A43]';
              ...
              <div key={order.id}>
                ...
                >
                  ...
                  <div className="flex flex-col items-start">
                    <span className={`font-extrabold text-[16px] ${sideColor}`}>
                      {isBuy ? 'Mua' : 'Bán'}
                    </span>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className="text-center text-[13px] text-gray-400 mt-0.5">{order.price}</span>
                  </div>
